...
//    private Button btnStart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainView = inflater.inflate(R.layout.fragment_game_block, container, false);
    ...
    private void initView(){
        imgHeart01 = mainView.findViewById(R.id.img_heart01);
        imgHeart02 = mainView.findViewById(R.id.img_heart02);
        imgHeart03 = mainView.findViewById(R.id.img_heart03);
        textCountDown = mainView.findViewById(R.id.text_countdown);
        textScore = mainView.findViewById(R.id.text_score);
//        btnStart = mainView.findViewById(R.id.btn_start);

        for (int i = 0; i < imgBlockElement.length; i++) {
            imgBlocklist[i] = mainView.findViewById(imgBlockElement[i]);
        }
    }
    ...
    private void getDialog() {
        ...
        builder.setNegativeButton("確認", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                initGame();
                mainActivity.btnsetting.setEnabled(true);
                mainActivity.btnScoreList.setEnabled(true);
            }
        });
        builder.create().show();
    }
